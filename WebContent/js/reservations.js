...
function filterReservations(){
	...
	var filter = $('#filterStatus :selected').val();


	if (loggedInUserRole == "GUEST") {
		fillInReservationsUser();
	} else if (loggedInUserRole == "ADMIN") {
		fillInReservationsAdmin(filter);
	} else if (loggedInUserRole == "HOST") {
		fillInReservationsHost(filter);
	} else {
		fillInReservationsUser();
	}
}
...
function fillInReservationsHost(filter) {
...
function fillInReservationsAdmin(filter) {
